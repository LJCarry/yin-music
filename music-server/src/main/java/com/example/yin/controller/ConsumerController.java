    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            if (os.toLowerCase().startsWith("win")) { // windos系统
                registry.addResourceHandler("/static/img/avatorImages/**")
                        .addResourceLocations("file:" + Constants.RESOURCE_WIN_PATH + "\\img\\avatorImages\\");
            } else { // MAC、Linux系统
                registry.addResourceHandler("/static/img/avatorImages/**")
                        .addResourceLocations("file:" + Constants.RESOURCE_MAC_PATH + "/static/img/avatorImages/");
            }
        }
    }
...
//    更新用户头像
    ...
    public Object updateUserPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "static/img" + System.getProperty("file.separator") + "avatorImages" ;
        ...
        String storeAvatorPath = "/static/img/avatorImages/" +fileName;
        try {
