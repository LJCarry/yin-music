    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            if (os.toLowerCase().startsWith("win")) { // windos系统
                registry.addResourceHandler("/static/img/singerPic/**")
                        .addResourceLocations("file:" + Constants.RESOURCE_WIN_PATH + "\\img\\singerPic\\");
            } else { // MAC、Linux系统
                registry.addResourceHandler("/static/img/singerPic/**")
                        .addResourceLocations("file:" + Constants.RESOURCE_MAC_PATH + "/static/img/singerPic/");
            }
        }
    }
...
//    更新歌手头像
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "static/img" + System.getProperty("file.separator") + "singerPic" ;
