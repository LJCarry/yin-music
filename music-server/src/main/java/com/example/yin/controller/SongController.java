    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            if (os.toLowerCase().startsWith("win")) { // windos系统
                registry.addResourceHandler("/static/img/songPic/**")
                ...
                registry.addResourceHandler("/static/img/songPic/**")
                        .addResourceLocations("file:" + Constants.RESOURCE_MAC_PATH + "/static/img/songPic/");
                registry.addResourceHandler("/song/**")
...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile){
        ...
        String pic = "/static/img/songPic/tubiao.jpg";
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "static/img" + System.getProperty("file.separator") + "songPic";
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
        ...
        File dest = new File(filePath + System.getProperty("file.separator") + fileName);
        String storeUrlPath = "/static/img/songPic/" +fileName;
        try {
